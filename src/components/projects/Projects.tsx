...
export default function Projects() {
  return (
    <main className="relative min-h-screen w-screen max-w-screen p-0 m-0 overflow-x-hidden flex flex-col items-center justify-center bg-transparent">
      <div className="flex flex-col items-center justify-center mt-8">
        ...
        <div className="flex flex-col items-center justify-center w-full h-full gap-4 p-4 md:p-8 lg:p-12">
          <ProjectBento />
        </div>
      </div>
    </main>
